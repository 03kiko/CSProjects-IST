...
void initCache() {
	...
	L2Cache.layer.buffer = L2CacheBuffer;
	L2Cache.layer.blockCount =  L2_SIZE / BLOCK_SIZE;
	L2Cache.layer.next = &DRAM;
	L2Cache.layer.readTime = L2_READ_TIME;
	L2Cache.layer.writeTime = L2_WRITE_TIME;
	L2Cache.lines = L2CacheLines;
	L2Cache.associative = 0;

	L1Cache.layer.buffer = L1CacheBuffer;
	L1Cache.layer.blockCount =  L1_SIZE / BLOCK_SIZE;
	L1Cache.layer.next = &L2Cache.layer;
