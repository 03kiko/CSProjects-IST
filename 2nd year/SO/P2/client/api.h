...
/// Provides a way for the client pipes to be closed, in case of
/// server failure.
...
/// @return -1 server disconnected; 0 if the event was created successfully;
///         1 otherwise.
...
/// @return -1 server disconnected; 0 if the reservation was created successfully;
///         1 otherwise.
...
/// @return -1 server disconnected; 0 if the event was printed successfully;
///         1 otherwise.
int ems_show(int out_fd, unsigned int event_id);

/// Prints all the events to the given file.
/// @param out_fd File descriptor to print the events to.
/// @return -1 server disconnected; 0 if the events were printed successfully;
///         1 otherwise.
