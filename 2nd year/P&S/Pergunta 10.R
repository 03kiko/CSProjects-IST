...
expect_freq <- sapply(1:k, function(i) {
  n * (F_triangular(classes[i + 1],a, b) - F_triangular(classes[i], a, b))
})


chisq_test <- chisq.test(observed_freq, p = expect_freq/sum(expect_freq))
